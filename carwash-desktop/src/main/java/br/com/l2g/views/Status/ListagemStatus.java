...
import br.com.l2g.views.servicos.*;
...
public class ListagemStatus extends javax.swing.JInternalFrame {
    ...
    private static final String URL_STATUS = URL_BASE + "servico";
    ...
    private void initComponents() {
        ...
        comboColunasBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Status", " " }));
    ...
    private void CarregaTabela() {
        try {
            ...
            HttpGet get = new HttpGet(URL_STATUS);
            String resposta = Util.enviaRequest(get);
            List<Status> servicolista = Arrays.asList(Util.jsonToObject(resposta, Status[].class));
            for (Status f : servicolista) {
                objects[0] = f.getIdStatus();
                objects[1] = f.getNomeStatus();
    ...
    private void IncluirStatus() {
        CadastroStatus view = new CadastroStatus(null, true, "incluir");
        view.setVisible(true);
        CarregaTabela();
    }

    private void AlterarStatus() {
        CadastroStatus view = new CadastroStatus(null, true, "editar");
        view.enviarCodigoSelecionado(jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0).toString());
        view.setVisible(true);
        CarregaTabela();
    }

    private void DeletarStatus() {
        try {
            ...
            if (opcao == 0 || opcao == -1) {
                String url_id = URL_STATUS + "/" + jTable1.getModel().getValueAt(jTable1.getSelectedRow(), 0).toString();
