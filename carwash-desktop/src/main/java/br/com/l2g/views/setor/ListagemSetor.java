 ...
 * @author lucas
 */
public class ListagemSetor extends javax.swing.JInternalFrame {
    ...
    public ListagemSetor(Usuario usuarioTelaPrincipal) {
        initComponents();
    ...
    private void CarregaTabela() {
        try {
            ...
            Logger.getLogger(ListagemSetor.class.getName()).log(Level.SEVERE, null, ex);
