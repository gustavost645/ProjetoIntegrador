 ...
 * @author lucas
 */
public class ListagemMarcas extends javax.swing.JInternalFrame {
    ...
    public ListagemMarcas(Usuario usuarioTelaPrincipal) {
        initComponents();
    ...
    private void CarregaTabela() {
        try {
            ...
            Logger.getLogger(ListagemMarcas.class.getName()).log(Level.SEVERE, null, ex);
